...
The BARS vatSys Plugin enables controllers participating in the plugin to manage and update airport lighting to directly reflect into simulators for pilots utilising the Pilot Client synchronising lighting status between controllers and pilots creating a more realistic controlling experience. 
